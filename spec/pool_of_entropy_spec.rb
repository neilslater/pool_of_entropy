  ...
  describe 'class methods' do
    describe '#new' do
      ...
      it 'should allow setting number of blocks in pool' do
        [1, 3, 5, 8, 13, 21, 34, 55, 89, 144, 233].each do |_s|
      ...
      it 'should accept and use :seeds array' do
        ...
        pool = PoolOfEntropy.new(blank: true, seeds: %w[foo bar])
        expect(pool).to be_a PoolOfEntropy
  ...
  describe 'instance methods' do
    pool_types = [
      ...
      [
        ...
        PoolOfEntropy.new(size: 256, blank: true, seeds: %w[dgeq dsfsf dsafsaf])
      ]
    ]
        ...
        describe '#rand' do
          ...
          context 'with a Range param' do
            ...
            it 'should return a different Integer each time (with high probability for large range) ' do
              expect(Set[*(1..100).map { pool.rand(100_000_000_000..200_000_000_000) }].size).to eql 100
            end
          end
        end
